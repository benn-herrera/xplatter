#ifndef HELLO_XPLATTERGY_H
#define HELLO_XPLATTERGY_H
...
/* Symbol visibility */
  ...
  #ifdef HELLO_XPLATTERGY_BUILD
    #define HELLO_XPLATTERGY_EXPORT __declspec(dllexport)
  #else
    #define HELLO_XPLATTERGY_EXPORT __declspec(dllimport)
  #endif
#elif defined(__GNUC__) || defined(__clang__)
  #define HELLO_XPLATTERGY_EXPORT __attribute__((visibility("default")))
#else
  #define HELLO_XPLATTERGY_EXPORT
#endif
...
/* lifecycle */
HELLO_XPLATTERGY_EXPORT int32_t hello_xplattergy_lifecycle_create_greeter(
    greeter_handle* out_result);
HELLO_XPLATTERGY_EXPORT void hello_xplattergy_lifecycle_destroy_greeter(
    greeter_handle greeter);

/* greeter */
HELLO_XPLATTERGY_EXPORT int32_t hello_xplattergy_greeter_say_hello(
    greeter_handle greeter,
    const char* name,
