...
func main() {
	fmt.Println("=== hello_xplattergy Go example ===")
	fmt.Println()
	...
	err := hello_xplattergy_lifecycle_create_greeter(&greeter)
	...
	err = hello_xplattergy_greeter_say_hello(greeter, name, &greeting)
	...
	err = hello_xplattergy_greeter_say_hello(greeter, name2, &greeting)
