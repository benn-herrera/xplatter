...
// GeneratedFileHeader returns a comment block identifying a file as generated by xplatter.
// commentPrefix is the line-comment prefix for the language (e.g. "//", "#").
// If scaffold is true, the header notes that the file won't be overwritten on regeneration.
func GeneratedFileHeader(ctx *Context, commentPrefix string, scaffold bool) string {
	version := ctx.Version
	if version == "" {
		version = "dev"
	}
	stamp := time.Now().Local().Format("2006-01-02 15:04:05 MST")
	var b strings.Builder
	fmt.Fprintf(&b, "%s Generated by xplatter %s on %s.\n", commentPrefix, version, stamp)
	if scaffold {
		fmt.Fprintf(&b, "%s This is a scaffold — customize as needed. Regeneration will not overwrite this file.\n", commentPrefix)
	} else {
		fmt.Fprintf(&b, "%s DO NOT EDIT — this file is regenerated each time xplatter runs.\n", commentPrefix)
	}
	return b.String()
}

// GeneratedFileHeaderBlock returns a C-style block comment (/* ... */) identifying a file
// as generated by xplatter. If scaffold is true, notes the file won't be overwritten.
func GeneratedFileHeaderBlock(ctx *Context, scaffold bool) string {
	...
	var b strings.Builder
	b.WriteString("/*\n")
	fmt.Fprintf(&b, " * Generated by xplatter %s on %s.\n", version, stamp)
	if scaffold {
		b.WriteString(" * This is a scaffold — customize as needed. Regeneration will not overwrite this file.\n")
	} else {
		b.WriteString(" * DO NOT EDIT — this file is regenerated each time xplatter runs.\n")
	}
	b.WriteString(" */\n")
	return b.String()
}
