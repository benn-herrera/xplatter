...
// RustImplGenerator produces Rust implementation scaffolding:
// a trait file, a C ABI shim file, and a stub implementation file.
...
func (g *RustImplGenerator) Generate(ctx *Context) ([]*OutputFile, error) {
	...
	traitFile, err := g.generateTrait(api, apiName)
	if err != nil {
		return nil, fmt.Errorf("generating trait file: %w", err)
	}

	ffiFile, err := g.generateFFI(api, apiName)
	if err != nil {
	...
	return []*OutputFile{traitFile, ffiFile, implFile}, nil
}

// generateTrait produces the trait definition file.
func (g *RustImplGenerator) generateTrait(api *model.APIDefinition, apiName string) (*OutputFile, error) {
	var b strings.Builder

	b.WriteString("// Auto-generated by xplattergy. DO NOT EDIT.\n\n")
...
func (g *RustImplGenerator) generateFFI(api *model.APIDefinition, apiName string) (*OutputFile, error) {
	var b strings.Builder
...
func (g *RustImplGenerator) generateImpl(api *model.APIDefinition, apiName string) (*OutputFile, error) {
	var b strings.Builder
...
// rustPrimitiveType maps an xplattergy primitive type to its Rust equivalent.
