...
func TestMakefilePackageDesktop(t *testing.T) {
	...
	if !strings.Contains(content, "DIST_DESKTOP_DYN_LIB := $(DIST_DIR)/desktop/lib/$(DESKTOP_LIB_NAME).$(DYLIB_EXT)") {
	...
	if !strings.Contains(content, "DIST_DESKTOP_LNK_LIB := $(DIST_DIR)/desktop/lib/$(DESKTOP_LIB_NAME).lib") {
